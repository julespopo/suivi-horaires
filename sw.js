const CACHE='suivi-horaires-v2-0-alpha1-4';
const ASSETS=['./','./index.html','./employee.html','./pilotage.html','./styles.css?v=2.0-alpha1.4','./config.js?v=2.0-alpha1.4','./app.js?v=2.0-alpha1.4','./manifest.json','./manifest-pilotage.json','./manifest-patrick.json','./manifest-jerome.json','./manifest-paul.json','./manifest-louis.json','./icons/icon.svg'];
