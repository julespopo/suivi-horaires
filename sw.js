const CACHE='suivi-horaires-v1-10-3';
const ASSETS=['./','./index.html','./employee.html','./pilotage.html','./styles.css','./config.js','./app.js','./manifest.json','./manifest-patrick.json','./manifest-jerome.json','./manifest-paul.json','./manifest-louis.json','./icons/icon.svg'];
