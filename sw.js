const CACHE='suivi-horaires-v2-0-alpha1-3';
const ASSETS=['./','./index.html','./employee.html','./pilotage.html','./styles.css?v=2.0-alpha1.3','./config.js?v=2.0-alpha1.3','./app.js?v=2.0-alpha1.3','./manifest.json','./manifest-pilotage.json','./manifest-patrick.json','./manifest-jerome.json','./manifest-paul.json','./manifest-louis.json','./icons/icon.svg'];
