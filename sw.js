const CACHE='suivi-horaires-v2-0-alpha1-7';
const ASSETS=['./','./index.html','./employee.html','./pilotage.html','./styles.css?v=2.0-alpha1.7','./config.js?v=2.0-alpha1.7','./app.js?v=2.0-alpha1.7','./manifest.json','./manifest-pilotage.json','./manifest-patrick.json','./manifest-jerome.json','./manifest-paul.json','./manifest-louis.json','./icons/icon.svg'];
